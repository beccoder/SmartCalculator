...
START_TEST(test_s21_calc) {
    ...
    s21_calc("96.35%3.265", &ans);
    ck_assert_double_eq_tol(1.665, ans, pow(10, -7));

    s21_calc("(-100)*(-100)*(-100)", &ans);
    ck_assert_double_eq_tol(-1000000, ans, pow(10, -7));

    s21_calc("cos(0)", &ans);
    ck_assert_double_eq_tol(1, ans, pow(10, -7));

    s21_calc("tan(0)", &ans);
    ck_assert_double_eq_tol(0, ans, pow(10, -7));

    s21_calc("sqrt(49)", &ans);
    ck_assert_double_eq_tol(7, ans, pow(10, -7));
}
END_TEST
